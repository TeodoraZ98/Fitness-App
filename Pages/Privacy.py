...
st.set_page_config(page_title="Privacy Policy", page_icon="logo.png", layout="wide")
...
### What We Collect
- Name, email, login activity  
- Usage and preference data  
- Fitness goals (if provided)

### How We Use It
- To improve your experience  
- Personalize features like meal plans  
- Never sold or shared without consent

### Your Rights
You can update or delete your data by contacting us.

---

📩 Questions? Reach out: [support@transformzone.com](mailto:support@transformzone.com)
