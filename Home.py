...
with col1:
    ...
    if st.button("Home", key="nav_home", help="Go to Home"):
        switch_page("Home")
    if st.button("Calculator", key="nav_calc", help="Go to Calculator"):
        switch_page("Calculator")
    if st.button("Meals", key="nav_meals", help="Go to Meals"):
        switch_page("Meals")
    if st.button("Supplements", key="nav_supps", help="Go to Supplements"):
...
with col3:
    ...
    if st.button("Premium", key="nav_premium"):
        switch_page("Premium")
